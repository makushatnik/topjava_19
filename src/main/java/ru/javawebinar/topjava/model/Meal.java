...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.GET_BY_ID_WITH_USER, query = "SELECT m FROM Meal m INNER JOIN FETCH m.user WHERE m.id=:id")
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String GET_BY_ID_WITH_USER = "Meal.getByIdWithUser";
