...
<section>
    ...
    <form method="post" action="${ctx}/meals/filter">
        <dl>
    ...
    <hr/>
    <a href="${ctx}/meals/add"><spring:message code="common.add"/></a>
    <hr/>
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr class="<%= meal.isExcess() ? "excess" : "normal"%>">
                ...
                <td>${meal.calories}</td>
                <td><a href="${ctx}/meals/${meal.id}"><spring:message code="common.update"/></a></td>
                <td><a href="${ctx}/meals/delete/${meal.id}"><spring:message code="common.delete"/></a></td>
            </tr>
        </c:forEach>
    </table>
</section>
